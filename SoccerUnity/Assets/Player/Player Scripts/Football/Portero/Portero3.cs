...
public class Portero3 : MonoBehaviour{
    ...
    void Update()
    {
        ...
        //Vector3 pointPlano = Vector3.Lerp(transBall.position,transCenterPorteria.position,ctrlDistancePortero.GetDistanceNormalized());
        ...
        //transPortero.rotation = Quaternion.LookRotation(transBall.position - new Vector3(transPortero.position.x,transBall.position.y,transPortero.position.z));
        Vector3 posPortero;
        float distance = ctrlDistancePortero.GetDistance() / maxDistancePosPortero;
        
        posPortero = Vector3.Lerp(transCenterPorteria.position, position, rigBall.velocity.magnitude / maxVelocityFollowPortero+(1-distance));
        //posPortero = Vector3.Lerp(position, posPortero, distance);
